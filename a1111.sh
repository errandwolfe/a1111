...
CHECKPOINT_MODELS=(
    "https://huggingface.co/Artguy32/ponyDiffusionV6XL_v6StartWithThisOne/blob/main/ponyDiffusionV6XL_v6StartWithThisOne.safetensors"
    "https://civitai.com/api/download/models/395263?type=Model&format=SafeTensor&size=pruned&fp=fp16"
